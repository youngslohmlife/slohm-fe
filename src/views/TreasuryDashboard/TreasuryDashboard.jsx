  ...
  useEffect(() => {
    ...
    apollo(treasuryDataQuery)
      .then(r => {
        ...
        if (r && r.data && r.data.protocolMetrics) {
          ...
          console.error("Treasury data response is not in the expected format:", r);
        }
      })
      .catch(error => {
    ...
    // Rebases data query
    apollo(rebasesDataQuery)
      .then(r => {
        // Check if the response and data exist
        if (r && r.data && r.data.rebases) {
          ...
          console.error("Rebases data response is not in the expected format:", r);
        }
      })
      .catch(error => {
        console.error("Error fetching rebases data:", error);
      });
  }, []);
